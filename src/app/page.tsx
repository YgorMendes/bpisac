    ...
    <main className="home">
      ...
      <section className="padding insta bgGray">
        <div className="insta_bg-img-container">
          ...
          <h2 className="insta_title">Acompanhe nosso trabalho no Instagram Já são mais de <span className="blue">110 mil seguidores</span> e mais de <span className="blue">3050 Feedbacks</span></h2>
