  ...
  return (
    <main className="home">
      ...
      <section className="consultant padding">
        ...
        <iframe className="video" src="https://www.youtube.com/embed/hzaYxTXeJkw?si=qoUCJDM0oEl9vUGK" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
      ...
      <section className="padding insta bgGray">
        <div className="insta_bg-img-container">
          ...
          <h2 className="insta_title">Acompanhe nosso trabalho no Instagram Já são mais de <span className="blue">110 mil seguidores</span> e mais de <span className="blue">3000 feedbacks</span></h2>
